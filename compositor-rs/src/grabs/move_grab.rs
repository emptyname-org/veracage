...
impl PointerGrab<State> for MoveSurfaceGrab {
    fn motion(
        ...
        let mut new_location: Point<i32, Logical> =
            (self.initial_window_location.to_f64() + delta).to_i32_round();
        // Don't let a window's top be dragged up under the toolbar strip.
        new_location.y = new_location.y.max(crate::toolbar::TOOLBAR_HEIGHT);
        data.space
