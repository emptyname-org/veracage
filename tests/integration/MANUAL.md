...
Ctrl+Alt+C sandbox->host / Ctrl+Alt+V host->sandbox, or the Edit > Push to
host / Edit > Pull to Veracage menu items).
...
### Test 11: Suspend dismounts the volume
...
Pass if waking up requires re-entering the volume password.
